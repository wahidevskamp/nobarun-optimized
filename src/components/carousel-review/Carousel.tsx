...
const Carousel: React.FC<CarouselProps> = ({
  ...
  return (
    ...
    >
      ...
      {showDots && (
        <DotGroup
          className={`custom-dot review__carousel-dot__wrapper`}
      ...
      {showArrow && (
        <Fragment>
          <IconButton
            ...
            className="arrow-button review__arrow-btn review__arrow-btn--left"
            as={ButtonBack}
            variant="contained"
          ...
          <IconButton
            ...
            className="arrow-button review__arrow-btn review__arrow-btn--right"
            as={ButtonNext}
            variant="contained"
            color={arrowButtonColor}
  ...
  for (let i = 0; i < total; i += step) {
    dots.push(
      <div
        key={i}
        className={clsx({
          'review__carousel-dot': true,
          'review__carousel-dot--active': currentSlide === i,
        })}
        onClick={() =>
